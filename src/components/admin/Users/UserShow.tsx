  ...
  return (
    <Show>
      <SimpleShowLayout>
        ...
        <TextField source="address" emptyText="Unknown" />
        <TextField source="emergencyContactName" emptyText="Unknown" />
        <TextField source="emergencyContactPhone" emptyText="Unknown" />
        <DateField
          source="lastSignIn"
